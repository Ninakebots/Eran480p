...
async def convert_video1(video_file, output_directory, total_time, bot, message, chan_msg, watermark_url='https://graph.org/file/d79c7f411a9d744a76614-791b31468835e64089.jpg'):
    if not os.path.exists(video_file):
