...
async def button(bot, update: CallbackQuery):
    ...
    if (update.from_user and update.message.reply_to_message and update.message.reply_to_message.from_user and (update.from_user.id == update.message.reply_to_message.from_user.id)) or g:
        ...
        try:
            ...
            ffmpeg = "-preset veryfast -c:v libx264 -s 854x480 -x264-params 'bframes=8:psy-rd=1:ref=3:aq-mode=3:aq-strength=0.8:deblock=1,1' -pix_fmt yuv420p -crf 30 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -ab 32k -vbr 2 -level 3.1 -threads 5"
