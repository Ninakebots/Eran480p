...
@app.on_message(filters.incoming & filters.command(["exec", f"exec@{BOT_USERNAME}"]) & is_auth)
...
@app.on_message(filters.incoming & filters.command(["eval", f"eval@{BOT_USERNAME}"]) & is_auth)
...
async def upload_log_file(client, message):
    if os.path.exists(LOG_FILE_ZZGEVC):
        ...
        await message.reply_text("❌ Lᴏɢ ғɪʟᴇ ɴᴏᴛ ғᴏᴜɴᴅ!")